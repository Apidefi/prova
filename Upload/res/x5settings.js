(function ( $, x5engine ) {
	...
	s.siteId = '54877DF3C1CED7ACAFDD509C1A1C9408';
	...
	if (s.imAdv.show) {
		...
		s.imAdv.message = { media: { "type": "image", "url": x5engine.settings.currentPath + "images/c.jpg", "width": 1170, "height": 1169 }, effect: 'animated swing advertising' };
		s.imAdv.message.media.onclick = function () { x5engine.utils.location('https://trial-4087.websitex5.me/home.html', null, false); };
		s.imAdv.attentionSeeker = { media: { "type": "image", "url": x5engine.settings.currentPath + "images/05.png", "width": 96, "height": 96 }, effect: 'animated swing' };
	}
	// Captcha
	b.push(function () {
...
priority: 1, bannerStyle: 'bar', position: 'top', acceptButton: false}); });
	b.push(function () { x.utils.setupPage(""); });
